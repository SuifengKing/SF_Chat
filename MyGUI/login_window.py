...
class Ui_LoginWindow(object):
    def setupUi(self, LoginWindow):
        ...
        self.label_name.setGeometry(QtCore.QRect(190, 20, 71, 31))
    ...
    def retranslateUi(self, LoginWindow):
        ...
        self.label_name.setText(_translate("LoginWindow", "<html><head/><body><p><span style=\" font-size:18pt; font-weight:600;\">随风</span></p></body></html>"))
