...
class Ui_UsersLists(object):
    def setupUi(self, UsersLists):
        ...
        UsersLists.resize(933, 646)
        UsersLists.setMinimumSize(QtCore.QSize(933, 646))
        UsersLists.setMaximumSize(QtCore.QSize(933, 646))
        ...
        self.label_show.setGeometry(QtCore.QRect(750, 120, 151, 471))
